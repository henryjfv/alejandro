...
class AyudaTaller extends StatefulWidget {
  @override
  _AyudaTallerItemState createState() => _AyudaTallerItemState();
}

class _AyudaTallerItemState extends State<AyudaTaller> {
  UserTaller usuario;
  double width = 0;
                ...
                child: RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    NotificadorEmail notificador = NotificadorEmail(
                        asunto: "Taller - Tengo un problema",
