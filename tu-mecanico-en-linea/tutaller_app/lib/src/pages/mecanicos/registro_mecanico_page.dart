...
class RegistroMecanicoPage extends StatefulWidget {
  @override
  _RegistroMecanicoPageState createState() => _RegistroMecanicoPageState();
}

class _RegistroMecanicoPageState extends State<RegistroMecanicoPage> {
    ...
    DatabaseService().configuracion.then((value) {
      if (options.isEmpty) {
        setState(() {
          ...
          urlContrato = value.urlContratoMecanico;
        });
      }
    });
  ...
  Future<void> registrarMecanico() async {
    if (_nombreController.text.isEmpty ||
      ...
      if (validaciones()) {
        UserApp res = await AuthProvider().registrarMecanico(UserMecanico(
